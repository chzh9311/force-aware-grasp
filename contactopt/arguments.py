...
def parse_dataset(args):
    ...
    if args.split == 'aug':
        args.train_dataset = 'data/contactopt_data/perturbed_contactpose_train.pkl'
        args.test_dataset = 'data/contactopt_data/perturbed_contactpose_test.pkl'
    elif args.split == 'fine':
        args.test_dataset = 'data/contactopt_data/contactpose_test.pkl'
    elif args.split == 'im':
        args.test_dataset = 'data/contactopt_data/ho3d_image.pkl'
    elif args.split == 'demo':
        args.test_dataset = 'data/contactopt_data/ho3d_image_demo.pkl'
    else:
