...
def fit_pca_to_axang(mano_pose, mano_beta):
    ...
    mano_model = ManoLayer(mano_root='data/mano_v1_2/models', use_pca=True, ncomps=45, side='right', flat_hand_mean=False)

    beta_in = torch.Tensor(mano_beta).unsqueeze(0)
    mano_model_orig = ManoLayer(mano_root='data/mano_v1_2/models', joint_rot_mode="axisang", use_pca=False, center_idx=None, flat_hand_mean=True)
    ...
    mano_model = ManoLayer(mano_root='data/mano_v1_2/models', use_pca=True, ncomps=15, side='right', flat_hand_mean=False)
...
def get_mano_closed_faces():
    ...
    mano_layer = manolayer.ManoLayer(
        joint_rot_mode="axisang", use_pca=False, mano_root='data/mano_v1_2/models', center_idx=None, flat_hand_mean=True
    )
...
def text_3d(text, pos, direction=None, degree=-90.0, density=10, font='/usr/share/fonts/truetype/noto/NotoSans-Regular.ttf', font_size=10):
    """
    ...
    img = Image.new('RGB', (width, height*2), color=(255, 255, 255))
